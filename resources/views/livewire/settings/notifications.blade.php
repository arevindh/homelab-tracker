<div class="py-6">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-10 sm:mt-0" wire:key="notification">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-12 sm:col-span-12">
                                    <label for="speedtest_notification"
                                        class="block text-sm font-medium text-gray-700">Speedtest Notification (Enable
                                        notification for every speedtest that runs)</label>
                                ...
                                <div class="col-span-12 sm:col-span-12">
                                    <label for="overview_notification"
                                        class="block text-sm font-medium text-gray-700">Speedtest Overview Notification
                                        (Enable a daily notification with average values for the last 24 hours)</label>
                                ...
                                <div class="col-span-12 sm:col-span-12">
                                    <label for="threshold_alert_absolute_notification"
                                        class="block text-sm font-medium text-gray-700 ">Threshold Alert Absolute
                                        Notification (Enable/Disable absolute threshold notifications) </label>
                                    <input type="checkbox" name="threshold_alert_absolute_notification"
                                        id="threshold_alert_absolute_notification" autocomplete="family-name"
                                ...
                                <div class="col-span-12 sm:col-span-12">
                                    <label for="threshold_alert_absolute_ping"
                                        class="block text-sm font-medium text-gray-700 ">Threshold Alert Absolute Ping
                                        (When the ping is higher than this value, a notification will be sent. Leave
                                        blank to disable) </label>
                                    <input type="number" name="threshold_alert_absolute_ping"
                                        id="threshold_alert_absolute_ping" autocomplete="family-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>
                        </div>
