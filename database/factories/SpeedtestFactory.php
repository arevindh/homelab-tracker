    ...
    public function definition()
    {
        return 
            [
                ...
                'download_bandwidth' => rand(8000000, 80000000) / 10,
                'download_bytes' => rand(8000000, 8000000),
                'download_elapsed' => rand(1000, 80000),
                'upload_bandwidth' => rand(8000000, 8000000) / 10,
                'upload_bytes' => rand(8000000, 8000000),
                'upload_elapsed' => rand(1000, 80000),
                'isp' => Str::random(10),
